  ...
  return (
    <Card className="flex h-full w-full flex-col items-center justify-center">
      <CardHeader className="flex w-1/2 flex-col items-center justify-center gap-8">
        ...
        <CardTitle className="text-7xl text-destructive text-center">
          Access Denied
        </CardTitle>
      </CardHeader>
      <CardContent className="flex w-1/2 flex-col justify-center gap-8 whitespace-pre-line text-pretty text-center">
        <div className="flex flex-col gap-4">
          <p className="text-lg">
            I feel like you&apos;re trying to be somewhere you shouldn&apos;t be..{' '}
            <span className="font-extrabold italic">
              but you knew that, didn&apos;t you {userProfile?.first_name}?
            </span>
          </p>
          <p className="text-muted-foreground">
            Turn around <span className="font-bold text-warning-foreground">slowly</span>,
            don&apos;t make any sudden moves, and we&apos;ll pretend it never happened.
          </p>
        </div>
