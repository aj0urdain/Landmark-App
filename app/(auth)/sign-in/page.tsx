  ...
  return (
    <div className="flex h-screen w-full items-center justify-center">
      <div className="relative flex h-full w-1/2">
        <div className="absolute left-0 top-0 z-10 h-full w-full bg-gradient-to-t from-slate-800 to-transparent" />
        <Image
        ...
        />
        <div className="absolute left-0 top-0 z-20 flex h-full w-full flex-col items-center justify-center gap-8">
          <LogoWordmark className="h-auto w-2/3" />
          <Separator orientation="vertical" className="h-0.5 w-1/2 bg-white" />
          <div className="flex items-center justify-center gap-6">
            <Dot size="small" />
            <Dot size="large" />
            <p className="font-lexia text-4xl font-bold uppercase tracking-widest">
              Landmark
            </p>
            <Dot size="large" />
            <Dot size="small" />
      ...
      <div className="flex h-full w-1/2 items-center justify-center">
        <Card className="max-h-96 w-full max-w-sm p-6">
