    ...
    Tables: {
      ...
      audit_log: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "audit_log_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
      ...
      document_history: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "document_history_edited_by_fkey"
            columns: ["edited_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "documents_document_owner_fkey"
      ...
      notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_notification_assignee_fkey"
      ...
      properties: {
        ...
        Relationships: [
          {
            foreignKeyName: "properties_lead_agent_fkey"
            columns: ["lead_agent"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
