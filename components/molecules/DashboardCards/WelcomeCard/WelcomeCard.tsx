  ...
  return (
    <Card className="relative h-full w-full overflow-hidden p-6">
        ...
        <div className="relative z-10 flex h-full flex-col justify-start gap-3">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-3xl">
              ...
              <span className="font-bold">{userProfile.last_name}</span>
            </p>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2">
            <div className="font-lexia font-bold">
              ...
              <AnimatedDigit digit={time.minutes[0]} prevDigit={prevTime.minutes[0]} />
              <AnimatedDigit digit={time.minutes[1]} prevDigit={prevTime.minutes[1]} />
      ...
      <div className="absolute -right-4 bottom-0 z-20 h-[100%] animate-slide-down-fade-in overflow-visible">
        <Image
          src={userProfile.profile_picture || '/images/default-profile-picture.png'}
