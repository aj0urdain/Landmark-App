...
const dummyTasks: Task[] = [
  ...
  },
  {
    ...
    description:
      "Prepare and distribute annual employee feedback questionnaire",
    due_date: new Date(Date.now() + 86400000 * 15).toISOString(), // 15 days from now
    priority: "medium",
    status: "in progress",
    assignee_ids: ["user-4"],
        ...
        <div className="flex-shrink-0">
          {isCollapsed ? (
            ...
            <Button
              ...
              } group w-full justify-between text-xs`}
              onClick={toggleLock}
            >
              {lockMessage ? (
                <span className="animate-slide-left-fade-in">
                  {lockMessage}
                </span>
              ) : (
                <>
